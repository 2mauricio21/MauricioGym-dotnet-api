...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "MauricioGym - API de Academias",
        Version = "v1",
        Description = "API para gerenciamento de academias e associações de usuários do sistema MauricioGym",
...
builder.Services.ConfigureServicesCadastroAcademia(builder.Configuration);
